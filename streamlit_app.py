        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "The content for this section can be found in the LP memo- please extract all important information. Please return all information on separate lines. Include relevant property information, investment summary, and rationale for the initial investment, from the LP memo. Please list all of the information on separate lines. Please include the 'client overview', including address and name of the client and guarantor."
                    "Section 2: Financial Information"
                    "Please extract all financial information from the PFS and the tax returns. From the PFS, please return in a table format the Net Worth, Total Liabilities, Total Liabilities & Net Worth, Total Assets and return them as numbers in bullet points. I want all information about the borrower to be included on separate lines."
